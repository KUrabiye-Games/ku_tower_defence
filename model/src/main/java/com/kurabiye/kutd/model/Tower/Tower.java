...
public class Tower implements ITower{
    ...
    public void setTileCoordinate(TilePoint2D tileCoordinate) {
        ...
        this.attackPoint = new Point2D(tileCoordinate.getCenter().getX(), (tileCoordinate.getCenter().getY() + TilePoint2D.TILE_HEIGHT / 2)); // Update the attack point of the tower
    }
